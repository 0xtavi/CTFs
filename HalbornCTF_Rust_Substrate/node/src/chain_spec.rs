...
use malborn_chain_primitives::{AccountId, Balance, BlockNumber, Signature};

use malborn_chain_runtime::{
    ...
    ValidatorsSetConfig, VestingConfig, AllocationsOraclesConfig
};
...
fn build_local_properties() -> Properties {
    ...
    props.insert("tokenSymbol".to_string(), json!("MAL"));
...
pub fn testnet_genesis(
    ...
    let vested_grants = grants.unwrap_or_else(|| {
        vec![(
            ...
            // 1. after 1000 blocks a cliff of 1000 MAL unlocks
            // 2. for the next 100000 blocks a grant of 100 MAL unlocks every 1000 blocks
            get_account_id_from_seed::<sr25519::Public>("Ferdie"),
            vec![
                (1_000, 1, 1, 1000 * MAL),      // Cliff
                (2_000, 1_000, 100, 100 * MAL), // Vesting
            ],
        )]
    });

    const ENDOWMENT: Balance = 10_000 * MAL;
    ...
    GenesisConfig {
        ...
        // Allocations
        pallet_membership_Instance5: Some(AllocationsOraclesConfig {
