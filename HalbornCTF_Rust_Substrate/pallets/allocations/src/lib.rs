...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn allocate(
            ...
            // Ensure that we are not allocating more coins than allowed by the system
            ensure!(
            ...
            // Save new number of coins allocated.
            <CoinsConsumed<T>>::put(coins_that_will_be_consumed);

          
            // Then we mint and send coins to the Fee receiver, User , and treasury
